...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 06, 2014 at 11:33 AM
...
--
-- Table structure for table `filmsapchieu`
--

CREATE TABLE IF NOT EXISTS `filmsapchieu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(500) COLLATE utf8_unicode_ci DEFAULT NULL,
  `director` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL,
  `cast` varchar(500) COLLATE utf8_unicode_ci DEFAULT NULL,
...
(4, 'image/template/2D.png'),
(5, 'image/template/3D.png'),
(6, 'image/template/4DX.png'),
